...
// $Id: RSS_0_91_Parser.java,v 1.1 2005/04/21 19:41:09 vecego Exp $
...
class RSS_0_91_Parser implements RSS_0_91_ParserIF {
	...
	public ChannelIF parse(ChannelIF cBuilder, Element root)
		...
		// 1 title element
		cBuilder.setTitle(channel.getChildTextTrim("title"));
	      ChannelIF chnl = cBuilder;
		...
		if (image != null) {
			ImageIF rssImage = ChannelBuilder.createImage(image
