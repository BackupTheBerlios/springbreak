...
//----------------------------------------------------------------------
//Parser Helpers
  public ChannelIF parse(ChannelIF cBuilder, URL aURL)
                throws IOException,ParseException {
    return parse(cBuilder, new InputSource(aURL.toExternalForm()), aURL);
  }

  public  ChannelIF parse(ChannelIF cBuilder, String url)
                throws IOException, ParseException {
    URL aURL = null;
    try {
      aURL = new URL(url);
  ...
  public  ChannelIF parse(ChannelIF cBuilder, File aFile)
                throws IOException, ParseException {
    URL aURL = null;
    try {
      aURL = aFile.toURL();
  ...
  public  ChannelIF parse(ChannelIF cBuilder,
  ...
  private  synchronized ChannelIF parse(ChannelIF cBuilder,
                                              Document doc)
