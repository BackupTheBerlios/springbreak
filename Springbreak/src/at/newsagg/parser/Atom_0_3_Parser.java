...
class Atom_0_3_Parser implements Atom_0_3_ParserIF {
  ...
  public ChannelIF parse(ChannelIF cBuilder, Element channel)
    ...
    // title element
      ...
      cBuilder.setTitle(channel.getChildTextTrim("title", defNS));
    ...
    */
    ...
    while (i.hasNext()) {
      ...
      ItemIF curItem = at.newsagg.model.parser.hibernate.ChannelBuilder.createItem (item, chnl, strTitle, strDesc,
