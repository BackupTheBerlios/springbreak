...
//TODO: schauen ob ich die 2 createChannelmethoden so möchte
    ...
    public static ItemIF createItem(Element itemElement, ChannelIF channel,
            String title, String description, URL link) {
        return new at.newsagg.model.parser.hibernate.Item(itemElement, channel, title, description, link);
...
//        return obj;
    ...
    public static ImageIF createImage(String title, URL location, URL link) {
        ImageIF obj = new at.newsagg.model.parser.hibernate.Image(title, location, link);
        
        return obj;
    }

    public static ItemGuidIF createItemGuid(ItemIF item, String location,
            boolean permaLink) {
