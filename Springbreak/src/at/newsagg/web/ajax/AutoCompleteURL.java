 ...
 * @author king
 * @version
 * created on 23.08.2005 14:42:26
 *
 */
public class AutoCompleteURL extends at.newsagg.web.ajax.BaseAjaxServlet {
    ...
    /**
     * setChannelDAO is called by AutoCompleteURLServletWrappingController during startup!
     * 
...
// Schlechte Version, weil man mit factory.refresh() zwingend alle Beans neu laded!
...
//            log.info("Available channelDAO: "+factory.containsBean("channelDAO"));
//           factory.refresh(); 
//            
//            
//           try {
...
//            }
    ...
    public String getXmlContent(HttpServletRequest request) {
        ...
        { 
          log.debug("find");
           c = (ChannelIF)i.next();
          xml.append("<item value=\"").append(c.getLocationString()).append("\">");
