 ...
 * @version
 * created on 25.08.2005 18:25:38
 *
 */
public class ReadFeedItemServletWrapper extends AbstractController implements
        ...
        public void afterPropertiesSet() throws Exception {
             ...
             * Roland Vecera
             */
            if (this.servletClass.getName().equals ("at.newsagg.web.ajax.ReadFeedItem"))
            {    
                logger.debug("ReadFeedItem found");
                ((ReadFeedItem)this.servletInstance).setItemDAO(this.getItemDAO());
            }
             else
