...
\begin{figure} [h]
\begin{lstlisting}[caption=Create an index]{Create an index}
CREATE INDEX tablename_attributename_index 
	ON tablename (attributename);
\end{lstlisting}
\label{lst:CreateIndexForGeneric}
\end{figure}
...
\\\\
Event Cloud uses the Spring Framework IoC container to 
\\\\
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!
